...
namespace RaipadWidgets {

    public class RaipadEntry : Gtk.Entry {

        public string hint_string;

        public RaipadEntry (string hint_string) {
    ...
    public class RaipadSearchEntry : RaipadEntry {

        bool is_searching;

        public RaipadSearchEntry (string hint_string) {
